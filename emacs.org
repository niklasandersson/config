...
#+begin_src emacs-lisp
 ...
 (set-face-attribute 'font-lock-comment-face nil :family "Monaspace Radon" :height na/default-font-size)  
  (set-face-attribute font-lock-doc-face nil :family "Monaspace Xenon" :height na/default-font-size)
  (set-face-attribute font-lock-doc-markup-face nil :family "Monaspace Xenon" :height na/default-font-size)
...
#+begin_src emacs-lisp
  (defun na/org-font-setup ()
    ...
    (set-face-attribute 'org-block nil :foreground nil :background "#1E1E2E" :inherit 'fixed-pitch)
    ...
    (set-face-attribute 'org-block-begin-line nil :inherit 'fixed-pitch :underline nil :foreground nil :background "#1E1E2E" :extend t :box '(:style released-button))
    (set-face-attribute 'org-block-end-line nil :inherit 'fixed-pitch :underline nil :foreground nil :background "#1E1E2E" :extend t :box '(:style released-button)))
#+end_src
