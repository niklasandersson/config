...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'fill-column-indicator nil :foreground "gray23")
...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'default nil :family "Monaspace Neon" :height na/default-font-size)
  (set-face-attribute 'fixed-pitch nil :family "Monaspace Neon" :height na/default-font-size)
  (set-face-attribute 'variable-pitch nil :family "Monaspace Xenon" :height na/default-font-size :weight 'regular)

  (set-face-attribute 'font-lock-comment-face nil :family "Monaspace Radon" :height na/default-font-size :foreground "gray23")  
  (set-face-attribute font-lock-doc-face nil :family "Monaspace Xenon" :height na/default-font-size :foreground "gray23")
  (set-face-attribute font-lock-doc-markup-face nil :family "Monaspace Xenon" :height na/default-font-size :foreground "gray23")
  (set-face-attribute 'font-lock-function-name-face nil :box nil)  
#+end_src
...
#+begin_src emacs-lisp
  (defun na/org-font-setup ()
    (dolist (face '((org-level-1 . 1.2)
                    ...
                    (org-level-7 . 1.0)
                    (org-level-8 . 1.0)))
      (set-face-attribute (car face) nil :family "Monaspace Xenon" :weight 'bold :box nil :height (cdr face)))
    ...
    (set-face-attribute 'org-block-begin-line nil :inherit 'fixed-pitch :underline nil :foreground nil :background "gray15" :extend t :box '(:style released-button))
    (set-face-attribute 'org-block-end-line nil :inherit 'fixed-pitch :underline nil :foreground nil :background "gray15" :extend t :box '(:style released-button)))
#+end_src
