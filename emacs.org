...
#+begin_src emacs-lisp
  (defun na/org-font-setup ()
    ...
    (set-face-attribute 'org-block nil :foreground nil :background "#2d2d2d" :inherit 'fixed-pitch)
    ...
    (set-face-attribute 'org-block-begin-line nil :inherit 'fixed-pitch :underline nil :foreground nil :extend t :box '(:style released-button))
    (set-face-attribute 'org-block-end-line nil :inherit 'fixed-pitch :underline nil :foreground nil :extend t :box '(:style released-button)))
#+end_src
